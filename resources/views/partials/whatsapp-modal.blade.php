<div x-data="{ open: false }">
    ...
    <button @click="open = true"
        class="flex flex-col items-center justify-center text-white hover:text-green-400 pe-4 text-xs font-medium w-full h-full cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mb-1 fill-current" viewBox="0 0 256 256">
