...
<div class="mt-5" x-data="{ open: false }">
    ...
    <button @click="open = true"
        class="w-full bg-green-600 hover:bg-yellow-500 text-white font-bold py-3 px-4 rounded-lg
               flex items-center justify-center text-base shadow-md transition">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="w-5 h-5 mr-3 fill-current">
    ...
    <template x-if="open">
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg w-80 p-6 relative">
                 <h3 class="text-lg font-bold mb-4 text-black dark:text-white">Hubungi Admin</h3>
                <ul class="space-y-2">
