<header class="bg-white/80 backdrop-blur-sm text-gray-900 sticky top-0 z-50 shadow-lg">
  <div class="mx-auto max-w-sm px-4 relative">
    <div class="flex items-center justify-center h-16 relative">

      {{-- Logo kiri --}}
      <a href="{{ route('landing.index') }}" class="absolute left-0 inline-flex items-center gap-2">
        <img src="{{ asset('Images/logo/lampeganmtrbdg.jpg') }}" alt="Lampegan Motor" class="h-7 w-7 rounded-md object-cover">
      </a>

      {{-- Judul tengah --}}
      <a href="{{ route('landing.index') }}" class="text-xl font-extrabold tracking-wide text-gray-900">
        Lampegan Motor
      </a>

      {{-- Instagram kanan --}}
      <a href="https://www.instagram.com/lampeganmotorbdg" target="_blank" rel="noopener"
         class="absolute right-8 text-gray-700 hover:text-black">
      ...
      {{-- TikTok kanan --}}
      <a href="https://www.tiktok.com/@lampeganmotorbdg" target="_blank" rel="noopener"
         class="absolute right-0 text-gray-700 hover:text-black">
