<div>
    @if($show && $report)
        <x-filament::modal id="weekly-report-modal" :show="$show" max-width="lg">
            <h2 class="text-lg font-bold mb-2">Weekly Report {{ $report->start_date }} - {{ $report->end_date }}</h2>
            ...
            <div class="flex justify-end gap-2">
                <x-filament::button wire:click="markAsRead">Oke</x-filament::button>
